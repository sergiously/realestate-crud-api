...
export interface PriceListingInput
  extends Optional<PriceListingAttributes, 'id'> {}
 ...
 */
class PriceListing
  extends Model<PriceListingAttributes, PriceListingInput>
  implements PriceListingAttributes
{
  public id!: number;
  public price!: number;
 ...
 */
sequelize.query(
  "SELECT SETVAL('price_listing_history_id_seq', (SELECT MAX(id) from price_listing_history), true);",
);

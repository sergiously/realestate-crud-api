 ...
 */
class PostStatus extends Model<PostStatusAttributes, PostStatusInput> implements PostStatusAttributes {
  public id!: number;
 ...
 */
sequelize.query("SELECT SETVAL('post_status_history_id_seq', (SELECT MAX(id) from post_status_history), true);");
